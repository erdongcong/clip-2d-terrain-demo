...
{
    private enum MaskType { Mask, MeshMask, SpriteMask };

    [SerializeField] private GameObject oMaskPrefab = null;
    [SerializeField] private GameObject oMeshMaskPrefab = null;
    [SerializeField] private GameObject oSpriteMaskPrefab = null;
    [SerializeField] private GameObject oClipTpl = null;
    [SerializeField] private MaskType oMaskType = MaskType.SpriteMask;
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        switch (oMaskType)
        {
            ...
            case MaskType.SpriteMask:
                {
                    Instantiate(oSpriteMaskPrefab, new Vector3(collideWorldPos.x, collideWorldPos.y, 0.0f), Quaternion.identity);
                    break;
                }
        }
    }
